      ...
      <div className="relative mx-auto grid w-full max-w-6xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:py-24">
        <div className="flex flex-col items-start gap-6">
          ...
          <p className="max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
            Build your own vocabulary decks, flip through smart flashcards, and
            lock the words in with quick review games. Five minutes a day is all
            it takes.
          </p>

          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            <Button size="lg" className="h-11 px-5 text-base" render={<Link href="/signup" />}>
              Start learning free
        ...
        <div className="relative">
          ...
          <div className="animate-float-soft absolute -left-3 top-8 flex items-center gap-2 rounded-2xl bg-card px-3 py-2 shadow-lg ring-1 ring-foreground/10 sm:-left-6">
          ...
          <div className="absolute -right-2 bottom-10 rounded-2xl bg-card px-4 py-3 shadow-lg ring-1 ring-foreground/10 sm:-right-5">
