  ...
  return (
    <footer className="border-t border-border bg-secondary/50">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
        ...
        <Stagger className="grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
          <StaggerItem variant="fade-in" className="flex flex-col gap-3">
            <Brand />
          ...
          {footerLinks.map((group) => (
            <StaggerItem key={group.title} variant="fade-in">
        ...
        <p className="py-6 text-xs text-muted-foreground">
          © {new Date().getFullYear()} Lexi. A UI concept — all data on this
          site is sample data.
        </p>
      </div>
    </footer>
